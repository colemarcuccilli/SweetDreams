...
export function createArticleSchema(article: {
  ...
  return {
    ...
    "url": `https://sweetdreamsmusic.com/blog/${article.slug}`,
    "datePublished": article.publishedDate,
    "dateModified": article.modifiedDate || article.publishedDate,
    "author": {
      "@type": "Person",
      "name": article.author || "Sweet Dreams Studio Team"
    },
    "publisher": {
      "@type": "Organization",
      "name": "Sweet Dreams Studio",
    ...
    "image": article.image || "https://sweetdreamsmusic.com/blog-default.jpg",
    "keywords": article.keywords?.join(", ") || "music production, recording studio, Fort Wayne",
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": `https://sweetdreamsmusic.com/blog/${article.slug}`
    }
  };
}
