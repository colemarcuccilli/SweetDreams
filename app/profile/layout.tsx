        ...
        <aside className={styles.sidebar}>
          ...
          <nav className={styles.sidebarNav}>
            ...
            <Link
              ...
              className={`${styles.navItem} ${pathname === '/profile/library' ? styles.navItemActive : ''}`}
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <Link
              ...
              className={`${styles.navItem} ${pathname === '/profile/public-profile' ? styles.navItemActive : ''}`}
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            {user && isAdmin(user.email) && (
              <>
                ...
                <Link
                  href="/profile/admin/client-library"
                  className={`${styles.navItem} ${pathname === '/profile/admin/client-library' ? styles.navItemActive : ''}`}
                >
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/>
                  </svg>
